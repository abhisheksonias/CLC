      ...
      <div className="max-w-7xl mx-auto px-2 sm:px-4 md:px-6 lg:px-8">
                ...
                <div>
                  ...
                  <ul className="space-y-1 sm:space-y-2">
                    {practiceAreas.map((area, index) => (
                      <li key={index}>
                        <Link to={area.link} className="text-xs sm:text-sm  hover:text-gray-700 transition-colors">
                          {area.label}
                        </Link>
                      </li>
                    ))}
                ...
                <div>
                  ...
                  <ul className="space-y-1 sm:space-y-2">
                    {quickLinks.map((item, index) => (
                      <li key={index}>
                        <Link to={item.to} className="text-xs sm:text-sm  hover:text-gray-700 transition-colors">
                          {item.label}
                        </Link>
                      </li>
                    ))}
            ...
            <div className="sm:col-span-2 lg:col-span-1">
              ...
              <div className="space-y-2 sm:space-y-3">
                ...
                <div className="flex items-center gap-2">
                  ...
                  <p className="text-xs sm:text-sm ">+91 99999 20118</p>
                </div>  
                <div className="flex items-center gap-2">
                  <Mail className="h-3 w-3 sm:h-4 sm:w-4  flex-shrink-0" />
                  <p className="text-xs sm:text-sm  break-all">vivek.sarin@clclaw.in</p>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="bg-[#163C0F] backdrop-blur-sm px-2 sm:px-4 py-2 text-xs text-white border-t border-gray-200/50">
          <div className="flex flex-col sm:flex-row justify-between items-center space-y-2 sm:space-y-0">
            <Link to="/" className="text-xs sm:text-sm hover:text-white transition-colors">
              www.clclaw.in
            </Link>
