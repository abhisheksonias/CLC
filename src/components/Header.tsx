        ...
        <div className="max-w-full mx-auto px-2 sm:px-4 py-3">
          <div className="flex justify-between items-center">
            <div className="px-2 sm:px-4 md:px-10 flex items-center">
              <img src="/clc-logo.png" alt="commercial law firm" className="h-10 sm:h-12 md:h-16 lg:h-18 w-auto" />
            </div>
        ...
        <div className="max-w-full mx-auto px-2 sm:px-4">
          <div className="flex justify-center space-x-2 sm:space-x-4 md:space-x-8 py-2">
            {locations.map((location) => (
              <button
                key={location}
                className="text-xs sm:text-sm text-white hover:text-primary transition-colors py-1 px-1 sm:px-2"
              >
                {location}
              </button>
            ))}
